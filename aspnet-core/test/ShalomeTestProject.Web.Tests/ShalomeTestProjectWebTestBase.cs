...
using ShalomeTestProject.Models.TokenAuth;
...
{
    public abstract class ShalomeTestProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ShalomeTestProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ShalomeTestProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ShalomeTestProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ShalomeTestProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ShalomeTestProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ShalomeTestProjectDbContext, Task<T>> func)
        {
            T result;
